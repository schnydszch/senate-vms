...
{
$query = mysql_query("DELETE FROM entry WHERE slno = '{$_GET['delnews']}'")or die('Error : ' . mysql_error());
...
{
     $sql_query="DELETE FROM entry WHERE slno=".$_GET['delete_id'];
     mysqli_query($sql_query);
	 $sql_query2 = "INSERT INTO entry (cardnumber) values ('123')";
...
<h4 class="m-t-0 header-title">Today's Report</h4>
                                    <?php
...
?>
<h5 align="center" style="color:blue">List of Visitors (Today)</h5>
<h4 align="center" style="color:blue">Total: <?php 
$ret=mysqli_query($con,"SELECT count(slno) as 'Count' from entry where date(toe) = CURDATE()");
...
?>
				...
				<!--<td><a href="delete.php?delrole=<?php //echo $row["entryid"]; ?>"><img src="images/icon/b_drop.png" alt="Delete" /></a></td>	-->
				
				
				<!--<td><button class="btn btn-danger btn-sm remove">Delete</button></td>-->
				<!--<td><a rel="tooltip" href="delete.php?delrole=<?php echo $row['entryid']; ?>" class="btn btn-danger btn-link" title="Delete"></td>-->
...
$cnt=$cnt+1;
                          ...
                          <div class="col-lg-12">
                                <div class="table-responsive table--no-card m-b-30">							
							<h5 align="center" style="color:blue">Reports Per Monitoring Personnel - Per Activity (Today)</h5>
<hr />
...
$cnt=$cnt+1;
                          ...
                          <div class="col-lg-12">
                                <div class="table-responsive table--no-card m-b-30">							
							<h5 align="center" style="color:blue">Reports Per Monitoring Personnel (Today)</h5>
<hr />
