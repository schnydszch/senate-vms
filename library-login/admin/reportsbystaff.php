                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Between</strong> Dates Reports (Filtered by Staff)
                                    </div>
                                    <div class="card-body card-block">
                                        <form method="get" enctype="multipart/form-data" class="form-horizontal" name="bwdatesreport" action="bwdates-reports-staffdetails.php">
