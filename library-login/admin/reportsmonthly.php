                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form method="post" enctype="multipart/form-data" class="form-horizontal" name="bwdatesreport" action="reportsmonthly-details.php">
    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Month Year</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="month" id="fromdate" name="fromdate" value="" class="form-control" required="">
