...
<body class="animsition">
 ...
 <?php
//todays visitors
 $query=mysqli_query($con,"select slno from entry where date(toe)=CURDATE();");
...
mysqli_stmt_store_result($stmt);
 ...
 ?>                       
<div>
<h2>Welcome to the administration panel of the Senate Legislative Library Services Visitor Monitoring System. This is where library monitors log in so that the entry of library users are logged in to the currently signed in staff.</h2>
<p><b><?php echo htmlspecialchars($_SESSION["firstname"]); ?><?php echo htmlspecialchars($_SESSION["surname"]); ?></b> is currently logged in.</p>
 ...
 <?php
//Yesterdays visitors
 $query1=mysqli_query($con,"select slno from entry where date(toe)=CURDATE()-1;");
...
//Last Sevendays visitors
 $query2=mysqli_query($con,"select slno from entry where date(toe)>=(DATE(NOW()) - INTERVAL 7 DAY);");
...
//Total Visitors visitors
 $query3=mysqli_query($con,"select slno from entry");
