...
$result="SELECT password FROM borrowers WHERE borrowernumber='$adminid'";
...
if($cpassword != $stmt)
        ...
        $sql=mysqli_query($con,"UPDATE borrowers SET password='$newpassword' where borrowernumber='$adminid'");
	   ...
	   if($sql)
        ...
        {
       $msg="The passwords did not matched";
       }

/*
$query=mysqli_query($con,"select borrowernumber from borrowers where borrowernumber='$adminid' and password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update borrowers set password='$newpassword' where borrowernumber='$adminid'");
$msg= "Your password successully changed"; 
} else {
...
<body class="animsition">
   ...
   <?php
$adminid=$_SESSION['cvmsaid'];
$ret=mysqli_query($con,"select * from borrowers where borrowernumber='$adminid'");
$cnt=1;
