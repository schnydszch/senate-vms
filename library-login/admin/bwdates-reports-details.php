...
<h4 class="m-t-0 header-title">Between Dates Report</h4>
                                    <?php
									
//if (false !== stripos($_SERVER['HTTP_REFERER'], "visitor-detail.php"))
