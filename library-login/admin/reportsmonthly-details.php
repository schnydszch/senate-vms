...
<h4 class="m-t-0 header-title">Monthly Report (<?php echo $monthname; ?>)</h4>
                                    <?php
...
$dayofweek = date('w', strtotime($fdate));
$result    = date('Y-m-d', strtotime(($day - $dayofweek).' day', strtotime($fdate)));
echo $result;
